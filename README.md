...
### [Go to folder 1_SAR_realizations](data/1_SAR_realizations)
...
### [Go to folder 2_Spatial_aggregations](data/2_Spatial_aggregations)
...
### [Go to folder 3_MAUP_effects](data/3_MAUP_effects)
...
### [Go to folder 4_t_tests](data/4_t_tests)
