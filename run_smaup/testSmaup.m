function Smaup = testSmaup(N, k, rhoEst)
%%% This function compute the S-maup statistical test
CV0_01 = [nan,25,100,225,400,625,900
...
CV0_05 = [nan,25,100,225,400,625,900
...
CV0_10 = [nan, 25,100,225,400,625,900
...
if (0.8 < rhoEst) && (rhoEst < 1.0)
    r = 0.9;
elseif (0.6 < rhoEst) && (rhoEst < 0.8)
    r = 0.7;
elseif (0.4 < rhoEst) && (rhoEst < 0.6)
    r = 0.5;
elseif (0.15 < rhoEst) && (rhoEst < 0.4)
    r = 0.3;
elseif (-0.15 < rhoEst) && (rhoEst < 0.15)
    r = 0;
elseif (-0.4 < rhoEst) && (rhoEst < -0.15)
    r = -0.3;
elseif (-0.6 < rhoEst) && (rhoEst < -0.4)
    r = -0.5;
elseif (-0.8 < rhoEst) && (rhoEst < -0.6)
    r = -0.7;
else 
    r = -0.9;
end

Crit_val0_01 = interp1(CV0_01(1,2:end), CV0_01(CV0_01(:,1)==r,2:end), N);
Crit_val0_05 = interp1(CV0_01(1,2:end), CV0_01(CV0_05(:,1)==r,2:end), N);
Crit_val0_10 = interp1(CV0_01(1,2:end), CV0_01(CV0_10(:,1)==r,2:end), N);

if Smaup > Crit_val0_01
    out = sprintf(strcat('==========================\nEstadistico M = ', ...
        num2str(Smaup), '\nPseudo p_value < 0.01 ***\nH0 is rejected', ...
        '\n=========================='));
elseif Smaup > Crit_val0_05
    out = sprintf(strcat('==========================\nEstadistico M = ', ...
        num2str(Smaup), '\nPseudo p_value < 0.05 **\nH0 is rejected', ...
        '\n=========================='));
elseif Smaup > Crit_val0_10
    out = sprintf(strcat('==========================\nEstadistico M = ', ...
        num2str(Smaup), '\nPseudo p_value < 0.10 *\nH0 is rejected', ...
        '\n=========================='));
else
